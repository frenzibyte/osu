...
{
    public partial class RangeShearedSlider : CompositeDrawable
    {
        /// <summary>
        ...
        public RangeShearedSlider()
        {
            ...
            InternalChildren = new[]
            {
                ...
                new Container
                {
                    ...
                    CornerRadius = 5f,
                    Masking = true,
                    ChildrenEnumerable = OsuColour.StarDifficultyGradient
                                                  .Zip(OsuColour.StarDifficultyGradient.Skip(1))
                                                  .Select((p, i) => new Box
                                                  {
                ...
                new Container
                {
                    ...
                    {
                        RelativeSizeAxes = Axes.Both,
                        Colour = Color4Extensions.FromHex("293330"),
                        Alpha = 0.75f,
                    },
                },
        ...
        private partial class UpperBoundSlider : BoundSlider
        {
            protected override void LoadComplete()
            {
                ...
                // push the left box slightly so the upper bound nub doesn't have weird left-side edges
                LeftBox.X = 5f;

                LeftBox.Blending = BlendingParameters.Additive;
                LeftBox.Colour = Color4.White.Opacity(0.2f);
