...
{
    public interface ISkinRulesetImplementation
    {
        /// <summary>
        ...
        Drawable? GetDefaultDrawableComponent(ISkinComponentLookup lookup);

        // - rename SkinComponentsContainerLookup to SkinLayoutLookup
        Drawable? GetDefaultRulesetLayout(SkinComponentsContainerLookup lookup);
