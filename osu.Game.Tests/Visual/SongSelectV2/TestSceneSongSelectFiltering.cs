...
namespace osu.Game.Tests.Visual.SongSelectV2
{
    public partial class TestSceneSongSelectFiltering : ScreenTestScene
    {
        ...
        public void TestSearchTextWithRulesetCriteria()
        {
            ...
            AddUntilStep("osu beatmap visible", () => carousel.DisplayableItems.Any(b => b.Ruleset.OnlineID == 0));

            AddStep("set filter to match all", () => filterTextBox.Current.Value = "Some");
        ...
        private void importBeatmapForRuleset(int rulesetId)
        {
            ...
            {
                imported = manager.Import(TestResources.CreateTestBeatmapSetInfo(3, rulesets.AvailableRulesets.Where(r => r.OnlineID == rulesetId).ToArray()))!;
            });
            ...
            AddUntilStep("wait for imported to arrive in carousel", () => songSelect.IsNull() || carousel.DisplayableItems.Any(s => s.BeatmapSet!.ID == imported.ID));
        }
