...
namespace osu.Game.Rulesets.Mania.UI
{
    ...
    public partial class ManiaTouchInputArea : VisibilityContainer
    {
        ...
        private IBindable<ManiaMobilePlayStyle> playStyle = null!;
        ...
        protected override void LoadComplete()
        {
            ...
            playStyle = rulesetConfig.GetBindable<ManiaMobilePlayStyle>(ManiaRulesetSetting.MobilePlayStyle);
            playStyle.BindValueChanged(p => enabled.Value = p.NewValue == ManiaMobilePlayStyle.LandscapeTouchControls, true);
