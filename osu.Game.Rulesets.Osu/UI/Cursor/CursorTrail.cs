...
namespace osu.Game.Rulesets.Osu.UI.Cursor
{
    public partial class CursorTrail : Drawable, IRequireHighFrequencyMousePosition
    {
        ...
        private class TrailDrawNode : DrawNode
        {
            ...
            private IUniformBuffer<CursorTrailParameters> parametersBuffer;
            ...
            public override void Draw(IRenderer renderer)
            {
                ...
                parametersBuffer ??= renderer.CreateUniformBuffer<CursorTrailParameters>();
                parametersBuffer.Data = new CursorTrailParameters
                {
                    FadeClock = time,
                ...
                shader.Bind();
                shader.AssignUniformBlock(@"m_CursorTrailParameters", parametersBuffer);
