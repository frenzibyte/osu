...
namespace osu.Game.Skinning
{
    ...
    public class SkinnableTargetInfo
    {
        ...
        public void Update(SkinnableInfo[] components)
        {
            foreach (var componentsPerRuleset in components.GroupBy(c => c.RulesetName))
                DrawableComponentInfo[componentsPerRuleset.Key ?? string.Empty] = componentsPerRuleset.ToArray();
        }
    }
}
