...
namespace osu.Game.Screens.OnlinePlay.Multiplayer.Spectate
{
    ...
    public class MultiSpectatorScreen : SpectatorScreen
    {
        ...
        protected override void LoadComplete()
        {
            ...
            Logger.Log($"{GetType().Name}.LoadComplete(): Stopping {nameof(MasterGameplayClockContainer)}.");
        ...
        private void onReadyToStart()
        {
            ...
            Logger.Log($"{GetType().Name}.onReadyToStart(): Seeking {nameof(MasterGameplayClockContainer)} to {startTime}ms.");
            masterClockContainer.Seek(startTime);
            Logger.Log($"{GetType().Name}.onReadyToStart(): Starting {nameof(MasterGameplayClockContainer)}.");
