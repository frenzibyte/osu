    ...
    internal partial class DiscordRichPresence : Component
    {
        ...
        private void updatePresence()
        {
            ...
            presenceUpdateDelegate = Scheduler.AddDelayed(() =>
            {
                ...
                Logger.Log(
                    presence.Party == null
                        ? $"Updating Discord RPC presence with activity status: {presence.State}, details: {presence.Details}"
                        : $"Updating Discord RPC presence with activity status: {presence.State}, details: {presence.Details}, party: {presence.Party.ID} {presence.Party.Size}/{presence.Party.Max} {presence.Party.Privacy}",
