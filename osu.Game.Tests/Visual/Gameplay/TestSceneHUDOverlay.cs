    ...
    public partial class TestSceneHUDOverlay : OsuManualInputManagerTestScene
    {
        ...
        private void createNew(Action<HUDOverlay>? action = null)
        {
            AddStep("create overlay", () =>
            {
                ...
                hudOverlay.InputCountController.Add(new KeyCounterMouseTrigger(MouseButton.Left));
                hudOverlay.InputCountController.Add(new KeyCounterMouseTrigger(MouseButton.Right));
