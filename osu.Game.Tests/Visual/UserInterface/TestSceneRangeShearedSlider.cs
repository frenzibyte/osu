...
{
    public partial class TestSceneRangeShearedSlider : OsuTestScene
    {
        [Cached]
        ...
        private RangeShearedSlider rangeSlider = null!;

        [SetUpSteps]
        public void SetUpSteps()
        {
            AddStep("create control", () => Child = rangeSlider = new RangeShearedSlider
            {
                Width = 200,
