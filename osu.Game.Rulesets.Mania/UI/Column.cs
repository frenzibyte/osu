...
namespace osu.Game.Rulesets.Mania.UI
{
    ...
    public partial class Column : ScrollingPlayfield, IKeyBindingHandler<ManiaAction>
    {
        ...
        private IBindable<bool> touchControls = new BindableBool();
        ...
        private void load(GameHost host, ManiaRulesetConfigManager? rulesetConfig)
        {
            ...
            if (rulesetConfig != null)
                touchControls = rulesetConfig.GetBindable<bool>(ManiaRulesetSetting.TouchControls);
        }
        ...
        {
            // if touch controls are enabled, disallow columns from handling touch directly.
