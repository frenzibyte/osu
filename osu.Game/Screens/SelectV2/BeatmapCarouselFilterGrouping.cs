...
#pragma warning restore CS0618 // Type or member is obsolete
                ...
                case GroupMode.BPM:
                    return getGroupsBy(b =>
                    {
                        double maxLength = aggregateMax(b, items, bb => bb.BPM);
                        return defineGroupByBPM(maxLength);
                    }, items);
                ...
                case GroupMode.Collections:
                    return getGroupsBy(b => defineGroupByCollections(b.MD5Hash), items);
        ...
        private GroupDefinition? defineGroupByCollections(string md5Hash)
        {
